    ...
    <div className="row">
      ...
      <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 info">
        ...
        <p>
          ...
          <p>
            <strong>K-Menet</strong> nơi tập trung đào tạo, quản lý, phát triển Streamer, tuyển
            thủ Esport, KOLs chuyên nghiệp.
          </p>
          <p><strong>K-Store</strong> công ty cung cấp các sản phẩm về công nghệ phòng game.</p>
          <p>
            <strong>Kagency</strong> được thành lập khi thấu hiểu nhu cầu của công việc truyền
            thông là đưa đến chiến lược, giải pháp giúp doanh nghiệp mang lại
            giá trị tài chính trong hoạt động và phát triển kinh doanh của mình.
          </p>
          <p>
